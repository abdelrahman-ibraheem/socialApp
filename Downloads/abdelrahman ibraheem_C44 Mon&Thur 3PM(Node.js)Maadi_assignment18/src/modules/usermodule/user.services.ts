...
import { createOtp } from '../../utils/Email/email.Otp';
...
import { TokenTypesEnum } from '../../middleware/auth.middleware';
...
import { PostModel } from "../postModule/post.Model";
import { sendEmail } from "../../utils/Email/sendEmail";
 ...
 interface IUserServices {
  ...
  Profile(req: Request, res: Response, next: NextFunction): Promise<Response>;
...
Profile = async (req: Request, res: Response) => {
  ...
  const groups = await this.usermodel.find({
    filter: { 
      participants:{
